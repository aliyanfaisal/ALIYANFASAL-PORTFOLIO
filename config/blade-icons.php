    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        // Renamed from the package default of 'icon' — this app already has its
        // own <x-icon> component (resources/views/components/icon.blade.php)
        // and the two collide otherwise.
        'default' => 'bicon',
